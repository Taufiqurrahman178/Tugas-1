...
<body>
    <div style="text-align: center; padding: 20px 0px;">
        <h1 style="margin-bottom: 10px;">Daftar Keranjang</h1>
            ...
            echo "<table border='1px'><thead><th>Kategori</th><th>Kode</th><th>Nama</th><th>Harga</th><th>Keterangan</th><th>Stock</th><th>Photo</th><th>Aksi</th></thead>";
                while($row = $result->fetch_assoc()) {?>
                    <tr>
                        ...
                        <td><a href="admin-produk-hapus.php?produk_id=<?php echo $row['produk_id'] ?>" class="tombol_hijau" onclick="return confirm('Anda ingin menghapus Produk ini?')">Hapus dari Keranjang</a></td>
                    </tr>
                <?php } 
        } else {
