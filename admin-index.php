...
<body>
    <div style="text-align: center; padding: 20px 0px;">
        ...
        <hr/>
            <div style="display: flex; justify-content: center;">
                <a href="admin-produk-tambah.php" class="tombol_hijau">Tambah Produk</a>
            </div>
                ...
                echo "<table border='1px'><thead><th>Kategori</th><th>Kode</th><th>Nama</th><th>Harga</th><th>Keterangan</th><th>Stock</th><th>Photo</th><th>Aksi</th></thead>";
                    while($row = $result->fetch_assoc()) {?>
                        <tr>
                            ...
                            <td><a href="admin-produk-hapus.php?produk_id=<?php echo $row['produk_id'] ?>" class="tombol" onclick="return confirm('Anda ingin menghapus Produk ini?')">Hapus</a></td>
                        </tr>
                    <?php } 
                echo "</table>";
            } else {
